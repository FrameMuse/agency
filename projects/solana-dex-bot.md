...
highlights:
    TypeScript/Bun + Python IPC architecture
    Solana SDK with PumpSwap integration
    Jito MEV support for transaction ordering
    Docker Compose with 3 services + healthchecks
---
